...
upstream:
    ...
    wcurl --curl-options="--clobber --netrc" "https://raw.githubusercontent.com/catppuccin/alacritty/refs/heads/main/catppuccin-mocha.toml" --output ./data/alacritty/catppuccin-mocha.toml
